...
def get_tencent_data():
    ...
    for i in data_his["chinaDayList"]:
        ...
        heal = i["heal"]
        dead = i["dead"]
        # print(confirm,confirm_now,suspect,heal,dead)
    ...
    for i in data_his["chinaDayAddList"]:
        ...
        heal_add = i["heal"]
        dead_add = i["dead"]
        # print(confirm_add, suspect_add, heal_add, dead_add)
        history[ds].update(
    ...
    for pro_infos in data_province:
        ...
        for city_infos in pro_infos["children"]:
            ...
            # print(update_time, province, city, confirm, confirm_add,confirm_now, heal, dead)
