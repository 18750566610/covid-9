...
var myChart3667 = echarts.init(chartDom);
var option;
...
$.ajax({
  cache:false,
  type:"GET",
  url:"../static/beautifulsoup/json/CityTopTen.json",
  dataType:"json",
  async:true,
  success:
    function (datas) {
    console.log(datas)
      return myChart3667.setOption({
        series:{
          name:'died',
          data:datas.died,
