...
var chartDom = document.getElementById('box8');
var myChart3680 = echarts.init(chartDom);
var option;
...
$.ajax({
  cache:false,
  type:"GET",
  url:"../static/beautifulsoup/json/asymptomaticTopProvince.json",
  dataType:"json",
  async:true,
  success:
    function (datas) {
    console.log(datas)
      return myChart3680.setOption({
        series:{
          name:'died',
          data:datas.died,
