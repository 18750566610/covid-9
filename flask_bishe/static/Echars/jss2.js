...
var myChart3669 = echarts.init(chartDom);
var option;
...
$.ajax({
  cache:false,
  type:"GET",
  url:"../static/beautifulsoup/json/CountryTopTen.json",
  dataType:"json",
  async:true,
  success:
    function (datas) {
    console.log(datas)
      return myChart3669.setOption({
        series:{
          name:'died',
          data:datas.died,
