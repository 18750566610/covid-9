...
var chartDom = document.getElementById('box10');
var myChart3690 = echarts.init(chartDom);
var option;
...
$.ajax({
  cache:false,
  type:"GET",
  url:"../static/beautifulsoup/json/diedTrueTopFive.json",
  dataType:"json",
  async:true,
  success:
    function (datas) {
    console.log(datas)
      return myChart3690.setOption({
        series:{
          name:'died',
          data:datas.died,
