...
var chartDom = document.getElementById('box7');
var myChart3730 = echarts.init(chartDom);
var option;
...
$.ajax({
  cache:false,
  type:"GET",
  url:"../static/beautifulsoup/json/topOverseasInput.json",
  dataType:"json",
  async:true,
  success:
    function (datas) {
    console.log(datas)
      return myChart3730.setOption({
        series:{
          name:'died',
          data:datas.died,
