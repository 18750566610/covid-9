...
var myChart3693 = echarts.init(chartDom);
var option;
...
$.ajax({
  cache:false,
  type:"GET",
  url:"../static/beautifulsoup/json/sevenContinents.json",
  dataType:"json",
  async:true,
  success:
    function (datas) {
    console.log(datas)
      return myChart3693.setOption({
        series:{
          name:'died',
          data:datas.died,
