try{
        ...
        //创建背景对象
        var bg = new PIXI.Sprite.fromImage("../static/res/plane/bg/img_bg_level_3.jpg");
        app.stage.addChild(bg);

        //创建云对象，设置云所在画布的坐标
        var yun = new PIXI.Sprite.fromImage("../static/res/texiao/yun02.png");
        app.stage.addChild(yun);
        yun.x = 20;
        yun.y = 130;

        //飞机动画，设置动画速度为0.1秒一张图片
        var alienImages = ["../static/res/plane/plays/planplay_1.png","../static/res/plane/plays/planplay_2.png","../static/res/plane/plays/planplay_3.png","../static/res/plane/plays/planplay_4.png","../static/res/plane/plays/planplay_5.png","../static/res/plane/plays/planplay_6.png","../static/res/plane/plays/planplay_7.png","../static/res/plane/plays/planplay_8.png","../static/res/plane/plays/planplay_9.png","../static/res/plane/plays/planplay_10.png","../static/res/plane/plays/planplay_11.png"];
        ...
        //添加僚机
        //僚机左
        var planeLeft = new PIXI.Sprite.fromImage("../static/res/plane/liaoji_02_11.png");
        ...
        //僚机右
        var planeRight = new PIXI.Sprite.fromImage("../static/res/plane/liaoji_02_11.png");
        ...
        var hpBg = new PIXI.Sprite.fromImage("../static/res/plane/ui/2_03.png");
        app.stage.addChild(hpBg);
        hpBg.y = 14;

        var hpTiao = new PIXI.Sprite.fromImage("../static/res/plane/ui/3_03.png");
        app.stage.addChild(hpTiao);
        hpTiao.x = 33;
        hpTiao.y = 14;
        
        var hpPic = new PIXI.Sprite.fromImage("../static/res/plane/ui/img_ui_16.png");
        app.stage.addChild(hpPic);
        hpPic.x = 10;
        hpPic.y = 12;

        var item = new PIXI.Sprite.fromImage("../static/res/plane/item/img_plane_item_15.png");
        ...
        //暂停
        var pauseBtn = new PIXI.Sprite.fromImage("../static/res/plane/ui/ui_new_btn_png_03.png");
        ...
        //继续游戏
        var continueBtn = new PIXI.Sprite.fromImage("../static/res/plane/ui/start.png");
        ...
        //gameover
        var gameoverBtn = new PIXI.Sprite.fromImage("../static/res/plane/ui/gameover.png");
        ...
        function fire(){
            if(fireTime == 0) {
                var bullet = new PIXI.Sprite.fromImage("../static/res/plane/bullet_02.png");
        ...
        */
        function Enemy() {
            ...
            this.init = function() {
                ...
                var img = "../static/res/plane/enemy_04.png";
                if(type == 1) {
                    img = "../static/res/plane/enemy_03.png";
                } else if(type == 2){
                    img = "../static/res/plane/enemy_02.png";
                }
                ...
                //添加血条
                this.hpBg = PIXI.Sprite.fromImage("../static/res/plane/item/img_plane_boss_02.png");
                this.hpFr = PIXI.Sprite.fromImage("../static/res/plane/item/img_plane_boss_05.png");
        ...
        */
        function EnemyBullet() {
            ...
            this.init = function(x, y) {
                ...
                this.image = new PIXI.Sprite.fromImage("../static/res/plane/bullet/img_bullet_17.png");
                this.image.x = x;
                this.image.y = y;
                //设置中心点
